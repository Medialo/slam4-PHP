...
class ModelVoiture extends Model {
   ...
   protected static $obj = 'Voiture';
    protected static $primary_key = 'immatriculation';
  ...
  /*  public static function save($m, $c, $i): void {
    ...
    //old method
    public static function updateCar($m,$c,$i){
        $sql = "UPDATE `voiture` SET `couleur` = :couleur, `marque` = :marque WHERE `voiture`.`immatriculation` = :immat ";
        $values = array(
            "couleur" => $c,
            "marque" => $m,
            "immat" => $i,
